...
class StrategyServiceImplTest {
    ...
    void findByParams() {
        ...
        List<Strategy> actualStrategies = strategyService.findByParams(strategyFindDto);
    ...
    void create() {
        ...
        Strategy expectedStrategy = Strategy.builder().name(strategyCreateDto.getName()).portfolio(portfolio).build();
