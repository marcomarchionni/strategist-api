...
class PortfolioSpecificationImplTest {
  ...
  @Mock FilterParser filterParser;

  @Mock PredicateBuilder predicateBuilder;

  @Mock Root<Portfolio> root;
  ...
  @Mock Predicate filterPredicate;

  @InjectMocks PortfolioSpecificationImpl portfolioSpecification;
