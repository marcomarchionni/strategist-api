...
class FileDataFetcherTest {
  ...
  @Autowired FileDataFetcher fileDataFetcher;
  ...
  void fetchFileInvalid() throws IOException {
    ...
    UpdateContext context = UpdateContext.builder().build();
  ...
  void fetch() throws IOException {
    ...
    int actualClosedDividendsSize =
        flexStatement.getChangeInDividendAccruals().getChangeInDividendAccrualList().size();
    assertEquals(14, actualClosedDividendsSize);
    int actualOpenDividendsSize =
        flexStatement.getOpenDividendAccruals().getOpenDividendAccrualList().size();
