...
class FlexServiceClientManagerImplTest {
  ...
  @Autowired FlexServiceClientManager flexServiceClientManager;

  @MockBean FlexServiceClient flexServiceClient;
  ...
  void fetchFlexStatementResponseWithRetry() {
    ...
    ResponseEntity<FlexStatementResponseDto> invalidFlexStatementResponse =
    ...
    // execute method
    FlexStatementResponseDto responseDto =
        flexServiceClientManager.fetchFlexStatementResponseWithRetry("queryId", "token");
  ...
  void fetchFlexQueryResponseWithRetry() {
    ResponseEntity<FlexQueryResponseDto> invalidFlexQueryResponse =
        ResponseEntity.internalServerError().build();
    ...
    FlexQueryResponseDto responseDto =
        flexServiceClientManager.fetchFlexQueryResponseWithRetry(
            getPopulatedFlexStatementResponseDto(), "token");
