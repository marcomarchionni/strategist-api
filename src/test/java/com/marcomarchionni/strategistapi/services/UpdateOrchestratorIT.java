...
public class UpdateOrchestratorIT {
        ...
        void updateFromFilePopulatedDbTest() throws IOException {
                ...
                long countTradesWithStrategyBefore = existingTrades.stream()
                ...
                long countTradesWithStrategyAfter = updatedTrades.stream().filter(trade -> trade.getStrategy() != null)
                                .count();
                ...
                assertEquals(existingDividends.size() + report.getDividends().getAdded().size(),
