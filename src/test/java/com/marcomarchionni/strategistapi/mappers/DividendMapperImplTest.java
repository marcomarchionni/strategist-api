...
class DividendMapperImplTest {
  ...
  void toClosedDividend() {
    FlexQueryResponseDto.ChangeInDividendAccrual d =
        FlexQueryResponseDto.ChangeInDividendAccrual.builder().build();
  ...
  @Test
  void toOpenDividend() {
    FlexQueryResponseDto.OpenDividendAccrual d =
        FlexQueryResponseDto.OpenDividendAccrual.builder()
            .currency("USD")
