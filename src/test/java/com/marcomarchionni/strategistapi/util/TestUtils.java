...
public class TestUtils {
  ...
  public static PositionFind getSamplePositionCriteria() {
    return PositionFind.builder().tagged(true).symbol("AAPL").build();
  }

  public static DividendFind getSampleDividendCriteria() {
    return DividendFind.builder().exDateAfter(LocalDate.of(2022, 6, 5)).build();
  }
  ...
  public static FlexStatementResponseDto getPopulatedFlexStatementResponseDto() {
    return FlexStatementResponseDto.builder()
        .url(
            "https://gdcdyn.interactivebrokers.com/Universal/servlet/FlexStatementService.SendRequest?t=xml")
        .referenceCode("123456789")
        .build();
  }

  public static FlexStatementResponseDto getEmptyFlexStatementResponseDto() {
    return FlexStatementResponseDto.builder().url(null).referenceCode(null).build();
  }
  ...
  public static FlexQueryResponseDto getPopulatedFlexQueryResponseDto() {
    var flexStatement =
        FlexQueryResponseDto.FlexStatement.builder()
            ...
            .build();
    var flexStatements =
        FlexQueryResponseDto.FlexStatements.builder().flexStatement(flexStatement).build();
    return FlexQueryResponseDto.builder().queryName("name").flexStatements(flexStatements).build();
  }

  public static FlexQueryResponseDto getEmptyFlexQueryResponseDto() {
    return FlexQueryResponseDto.builder().queryName(null).flexStatements(null).build();
  }
}
