...
class FlexStatementAccessServiceImplTest {
  ...
  @Mock FlexStatementRepository flexStatementRepository;
  ...
  void setUp() {
    ...
    flexStatementAccessService =
        new FlexStatementAccessServiceImpl(
            flexStatementRepository, userService, accountIdValidator);
  ...
  void saveException() {
    ...
    assertThrows(
        InvalidUserDataException.class, () -> flexStatementAccessService.save(flexStatement));
  }
  ...
  void findFirstOrderByToDateDesc() {
    when(flexStatementRepository.findFirstByAccountIdOrderByToDateDesc("U1111111"))
        .thenReturn(Optional.of(flexStatement));
    FlexStatement actualFlexStatement =
        flexStatementAccessService.findFirstOrderByToDateDesc().get();
