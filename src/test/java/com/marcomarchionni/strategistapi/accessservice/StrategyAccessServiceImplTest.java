...
class StrategyAccessServiceImplTest {
  ...
  void setUp() {
    ...
    strategyAccessService =
        new StrategyAccessServiceImpl(userService, strategyRepository, accountIdValidator);
  ...
  @Test
  void findById() {
    when(strategyRepository.findByIdAndAccountId(1L, "U1111111"))
        .thenReturn(Optional.ofNullable(expectedStrategy));
  ...
  void saveEx() {
    ...
    assertThrows(
        InvalidUserDataException.class, () -> strategyAccessService.save(expectedStrategy));
  }
  ...
  void deleteException() {
    ...
    assertThrows(
        InvalidUserDataException.class, () -> strategyAccessService.delete(expectedStrategy));
  }
}
