...
class AuthenticationControllerTest {
  ...
  void signinValidData() throws Exception {
    var signInDto = SignInReq.builder().email("marco@gmail.com").password("password").build();
  ...
  void signinInvalidData(String email, String password) throws Exception {
    var signInDto = SignInReq.builder().email(email).password(password).build();
  ...
  void refresh() throws Exception {
    var refreshTokenResponse =
        new RefreshTokenResponse("accessTokenaaaaaaa", "refreshTokenbbbbbbb");
    ...
    mockMvc
        ...
        .andExpect(
            content()
                .json(
                    "{\"accessToken\":\"accessTokenaaaaaaa\","
