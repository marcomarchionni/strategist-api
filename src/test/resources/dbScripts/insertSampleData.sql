...
INSERT INTO `strategy` (`name`,`strategy_portfolio_id`) VALUES ('TTWO long',@SaverId);
...
INSERT INTO `position` (`id`,`con_id`,`report_date`,`position_strategy_id`,`symbol`,`description`,`asset_category`,`put_call`,`strike`,`expiry`,`quantity`,`cost_basis_price`,`mark_price`,`multiplier`,`cost_basis_money`,`position_value`,`fifo_pnl_unrealized`) VALUES (265598,265598,'2022-06-30',@ZMId,'AAPL','APPLE INC','STK',NULL,NULL,NULL,540,16.0184,136.7200,1,NULL,NULL,NULL);
...
INSERT INTO `dividend` (`id`,`con_id`,`dividend_strategy_id`,`symbol`,`description`,`ex_date`,`pay_date`,`gross_rate`,`quantity`,`gross_amount`,`tax`,`net_amount`,`open_closed`) VALUES (26754720220603,267547,NULL,'CGNX','COGNEX CORP','2022-05-19','2022-06-03',0.0650,44,2.8600,0.4300,2.4300,'CLOSED');
INSERT INTO `dividend` (`id`,`con_id`,`dividend_strategy_id`,`symbol`,`description`,`ex_date`,`pay_date`,`gross_rate`,`quantity`,`gross_amount`,`tax`,`net_amount`,`open_closed`) VALUES (434708620220617,4347086,@EBAYId,'EBAY','EBAY INC','2022-05-31','2022-06-17',0.2200,100,22.0000,3.3000,18.7000,'OPEN');
INSERT INTO `dividend` (`id`,`con_id`,`dividend_strategy_id`,`symbol`,`description`,`ex_date`,`pay_date`,`gross_rate`,`quantity`,`gross_amount`,`tax`,`net_amount`,`open_closed`) VALUES (510058320220711,5100583,NULL,'FDX','FEDEX CORPORATION','2022-06-24','2022-07-11',1.1500,47,54.0500,8.1100,45.9400,'OPEN');
INSERT INTO `dividend` (`id`,`con_id`,`dividend_strategy_id`,`symbol`,`description`,`ex_date`,`pay_date`,`gross_rate`,`quantity`,`gross_amount`,`tax`,`net_amount`,`open_closed`) VALUES (4512773920220627,45127739,NULL,'CME','CME GROUP INC','2022-06-09','2022-06-27',1.0000,10,10.0000,1.5000,8.5000,'CLOSED');
