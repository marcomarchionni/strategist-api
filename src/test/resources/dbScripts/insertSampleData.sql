...
INSERT INTO `dividend` (`id`,`con_id`,`dividend_strategy_id`,`symbol`,`description`,`ex_date`,`pay_date`,`gross_rate`,`quantity`,`gross_amount`,`tax`,`net_amount`,`open_closed`) VALUES (434708620220531,4347086,@EBAYId,'EBAY','EBAY INC','2022-05-31','2022-06-17',0.2200,100,22.0000,3.3000,18.7000,'CLOSED');
