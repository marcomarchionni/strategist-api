...
public class UpdateContext {
    @com.marcomarchionni.strategistapi.validators.SourceType
    ...
    public UpdateContext.SourceType getSourceType() {
        if (sourceType != null) {
            return UpdateContext.SourceType.valueOf(sourceType);
        }
        return null;
    }
