...
public class UpdateDto {
  @NotNull private FlexStatement flexStatement;
  @NotNull private List<Trade> trades;
  @NotNull private List<Position> positions;
  @NotNull private List<Dividend> dividends;
}
