...
public class UpdateServiceImpl implements UpdateService {
  ...
  public CombinedUpdateReport update(FlexQueryResponseDto dto) {
    ...
    var flexStatementReport =
        flexStatementService.updateFlexStatements(updateDto.getFlexStatement());
    ...
    // Return report
    return CombinedUpdateReport.builder()
        .flexStatements(flexStatementReport)
        .trades(tradeReport)
