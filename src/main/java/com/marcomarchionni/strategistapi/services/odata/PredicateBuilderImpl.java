...
public class PredicateBuilderImpl implements PredicateBuilder {
  ...
  private final Map<
          String, QuadFunction<Root<Portfolio>, CriteriaBuilder, String, String, Predicate>>
  ...
  private void initializePredicateMap() {
    ...
    PREDICATE_MAP.put(
        "startswith",
        (root, criteriaBuilder, field, value) ->
  ...
  public Predicate build(
      Root<Portfolio> root, CriteriaBuilder criteriaBuilder, ParsedFilter filter) {
    return PREDICATE_MAP
        .get(filter.expression())
        .apply(root, criteriaBuilder, filter.field(), filter.value());
  }
}
