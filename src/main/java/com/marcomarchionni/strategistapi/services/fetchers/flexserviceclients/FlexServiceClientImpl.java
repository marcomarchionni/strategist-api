...
public class FlexServiceClientImpl implements FlexServiceClient {
  ...
  @Override
  public ResponseEntity<FlexStatementResponseDto> fetchFlexStatementResponse(
      String queryId, String token) {

    try {
      return restTemplate.exchange(
          authUrl, HttpMethod.GET, requestEntity, FlexStatementResponseDto.class, token, queryId);
  ...
  @Override
  public ResponseEntity<FlexQueryResponseDto> fetchFlexQueryResponse(
