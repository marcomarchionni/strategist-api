...
public class ModelMapperConfig {
  ...
  private static PropertyMap<FlexQueryResponseDto.FlexStatement, FlexStatement>
      getFlexStatementPropertyMap() {
    return new PropertyMap<>() {
      @Override
      protected void configure() {
        skip().setId(null);
  ...
  // the update process
  private static PropertyMap<FlexQueryResponseDto.ChangeInDividendAccrual, Dividend>
      getClosedDividendPropertyMap() {
    return new PropertyMap<>() {
      protected void configure() {
        skip().setId(null);
        map().setConId(source.getConid());
  ...
  private static PropertyMap<FlexQueryResponseDto.OpenDividendAccrual, Dividend>
      getOpenDividendPropertyMap() {
    return new PropertyMap<>() {
      @Override
      protected void configure() {
        skip().setId(null);
