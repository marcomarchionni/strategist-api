...
public class Pointcuts {
  ...
  @Pointcut(
      "execution(com.marcomarchionni.strategistapi.domain.* com.marcomarchionni.strategistapi.*.*.*(..)))")
  public void returningEntities() {}

  @Pointcut(
      "execution(com.marcomarchionni.strategistapi.dtos.update.* com.marcomarchionni.strategistapi.*.*.*(..)))")
