...
public class ServiceLoggingAspect {
  @AfterThrowing(
      value = "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClasses()",
      throwing = "ex")
  ...
  @AfterReturning(
      pointcut =
          "com.marcomarchionni.strategistapi.logging.Pointcuts.servicesClassesReturningReport()",
      returning = "updateReport")
  public void logUpdateReport(JoinPoint joinPoint, UpdateReport<?> updateReport) {
    ...
    Stream<?> combinedStream =
        Stream.concat(
            Stream.concat(updateReport.getAdded().stream(), updateReport.getMerged().stream()),
            Stream.concat(updateReport.getDeleted().stream(), updateReport.getSkipped().stream()));
    String entityName =
        combinedStream
            .findFirst()
            .map(Object::getClass)
  ...
  @AfterReturning(
      pointcut =
          "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClassesReturningEntities()",
      returning = "entity")
  ...
  @AfterReturning(
      pointcut =
          "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClassesReturningList()",
      returning = "entities")
