...
public class ServiceLoggingAspect {
    @AfterThrowing(value = "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClasses()", throwing = "ex")
    public void logSaveAllException(Exception ex) {
        logWarning("Service throws Exception, message: " + ex.getMessage());
    }

    @AfterReturning(pointcut = "com.marcomarchionni.strategistapi.logging.Pointcuts.servicesClassesReturningReport()",
            returning =
                    "updateReport")
    ...
    @AfterReturning(pointcut = "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClassesReturningEntities()",
            returning = "entity")
    ...
    @AfterReturning(pointcut = "com.marcomarchionni.strategistapi.logging.Pointcuts.serviceClassesReturningList()",
            returning = "entities")
