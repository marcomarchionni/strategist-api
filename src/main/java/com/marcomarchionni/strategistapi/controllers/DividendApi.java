...
public interface DividendApi {
  @GetMapping
  @Operation(
      summary = "Find dividends by filter",
      parameters = {
        ...
        @Parameter(
            name = "tagged",
            description = "Dividend assigned to a strategy",
            example = "false"),
      })
  ...
  @Operation(
      summary =
          "Assign dividend to a strategy. Use strategyId = null to unassign dividend from any strategy.")
