...
public interface TradeApi {
  ...
  @GetMapping
  @Operation(
      summary = "Find trades by filter",
      parameters = {
        @Parameter(
            name = "tradeDateAfter",
            description = "Trade date after",
            example = "2021-01-01",
            in = ParameterIn.QUERY,
            schema = @Schema(type = "string", format = "date")),
        @Parameter(
            name = "tradeDateBefore",
            description = "Trade date before",
            example = "2024-02-02",
            in = ParameterIn.QUERY,
            schema = @Schema(type = "string", format = "date")),
        @Parameter(
            name = "tagged",
            description = "Trade assigned to a strategy",
            example = "false",
            in = ParameterIn.QUERY,
        ...
        @Parameter(
            name = "assetCategory",
            description = "Asset category. Allowed values: STK, OPT, FUT, " + "CASH",
            example = "STK",
            in = ParameterIn.QUERY,
            schema = @Schema(type = "string"))
      })
  ...
  @Operation(
      summary =
          "Assign a trade to a strategy. If strategyId is null, the trade will be unassigned from any "
              + "strategy.")
