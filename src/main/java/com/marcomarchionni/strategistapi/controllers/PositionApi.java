...
public interface PositionApi {
  @GetMapping
  @Operation(
      summary = "Find positions by filter",
      parameters = {
        @Parameter(
            name = "tagged",
            description = "Position assigned to a strategy",
            example = "false"),
  ...
  @Operation(
      summary =
          "Assign position to a strategy. Use strategyId = null to unassign position from any strategy.")
