...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleDataIntegrityViolationException(
    ...
    if (ex.getCause()
        instanceof org.hibernate.exception.ConstraintViolationException constraintViolationEx) {
  ...
  public ResponseEntity<Object> handleExpiredJwtException(ExpiredJwtException ex) {
    ProblemDetail pd =
        ProblemDetail.forStatusAndDetail(
            HttpStatus.UNAUTHORIZED, "The token has expired. " + ex.getMessage());
  ...
  protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(
    ...
    String detail =
        String.format(
            "The parameter '%s' has an invalid value '%s'. Expected values: %s",
            ex.getName(),
            ex.getValue(),
  ...
  public ResponseEntity<Object> handleInvalidFilterException(Exception ex) {
    ProblemDetail pd =
        ProblemDetail.forStatusAndDetail(
            HttpStatus.BAD_REQUEST, "Invalid filter parameter: " + ex.getMessage());
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    ProblemDetail body =
        createProblemDetail(
            ex,
            status,
            "Failed to read request. Request body is null or " + "invalid",
            null,
            null,
            request);
