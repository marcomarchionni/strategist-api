...
public interface PortfolioApi {
  ...
  ApiResponse<PortfolioSummary> findAll(
      ...
      @Parameter(description = "Number of records to return")
          ...
          int top,
      @Parameter(description = "Sort field and direction (e.g., 'name', 'name desc')")
          @RequestParam(required = false)
          String orderBy,
      @Parameter(description = "Filter by portfolio name (case-insensitive contains)")
          @RequestParam(required = false)
          String name,
      @Parameter(description = "Filter by portfolio description (case-insensitive contains)")
          @RequestParam(required = false)
          String description,
      @Parameter(description = "Filter portfolios created after this date (YYYY-MM-DD)")
          @RequestParam(required = false)
          String createdAfter,
      @Parameter(description = "Filter portfolios created before this date (YYYY-MM-DD)")
          @RequestParam(required = false)
  ...
  PortfolioSummary updatePortfolio(
