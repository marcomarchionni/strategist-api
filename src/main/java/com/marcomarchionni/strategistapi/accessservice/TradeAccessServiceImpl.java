...
public class TradeAccessServiceImpl implements TradeAccessService {
  ...
  @Override
  public List<Trade> findByParams(
      LocalDate startDate, LocalDate endDate, Boolean tagged, String symbol, String assetCategory) {
    String accountId = userService.getUserAccountId();
    return tradeRepository.findByParams(
        accountId, startDate, endDate, tagged, symbol, assetCategory);
  }
