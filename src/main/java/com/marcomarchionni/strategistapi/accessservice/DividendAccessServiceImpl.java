...
public class DividendAccessServiceImpl implements DividendAccessService {
  ...
  @Override
  public List<Dividend> findByParams(
      LocalDate exDateFrom,
      LocalDate exDateTo,
    ...
    return dividendRepository.findByParams(
        accountId, exDateFrom, exDateTo, payDateFrom, payDateTo, tagged, symbol);
  }
