...
public class FlexQueryResponse {
    ...
    @JsonIgnore
    public List<FlexQueryResponse.Trade> getTradesDto() {
        return getFlexStatements().getFlexStatement().getTrades().getTradeList();
    }

    @JsonIgnore
    public List<FlexQueryResponse.OpenPosition> getPositionsDto() {
        return getFlexStatements().getFlexStatement().getOpenPositions().getOpenPositionList();
    }

    @JsonIgnore
    public List<FlexQueryResponse.ChangeInDividendAccrual> getClosedDividendsDto() {
        return getFlexStatements().getFlexStatement().getChangeInDividendAccruals().getChangeInDividendAccrualList();
    }

    @JsonIgnore
    public List<FlexQueryResponse.OpenDividendAccrual> getOpenDividendsDto() {
        return getFlexStatements().getFlexStatement().getOpenDividendAccruals().getOpenDividendAccrualList();
    }

    @JsonIgnore
    public FlexQueryResponse.FlexStatement getFlexStatement() {
        return getFlexStatements().getFlexStatement();
    }

    @JsonIgnore
    public List<Order> getOrdersDto() {
        return getFlexStatements().getFlexStatement().getTrades().getOrderList();
    }
    ...
    public static class OpenPositions {
        ...
        public void setOpenPositionList(List<FlexQueryResponse.OpenPosition> values) {
