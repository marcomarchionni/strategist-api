...
public class FlexQueryResponseDtoOld {
    ...
    public static class ChangeInDividendAccruals {
        ...
        // Getter Methods
        public ArrayList<FlexQueryResponseDtoOld.ChangeInDividendAccrual> getChangeInDividendAccrual() {
            return ChangeInDividendAccrual;
        }

        // Setter Methods
        public void setChangeInDividendAccrual(ArrayList<FlexQueryResponseDtoOld.ChangeInDividendAccrual> changeInDividendAccrual) {
    ...
    public static class OpenDividendAccruals {
        ...
        public ArrayList<FlexQueryResponseDtoOld.OpenDividendAccrual> getOpenDividendAccrual() {
            return OpenDividendAccrual;
        }

        public void setOpenDividendAccrual(ArrayList<FlexQueryResponseDtoOld.OpenDividendAccrual> openDividendAccrual) {
    ...
    public static class Trades {
        ...
        public ArrayList<FlexQueryResponseDtoOld.Trade> getTrade() {
            return Trade;
        }

        // Setter Methods

        public void setTrade(ArrayList<FlexQueryResponseDtoOld.Trade> trade) {
            Trade = trade;
        }
    }
